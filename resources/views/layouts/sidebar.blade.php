...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-item">
    ...
    <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
      ...
      <li>
        <a href="{{route('user.add-role')}}">
          <i class="bi bi-circle"></i><span>Add Roles</span>
        </a>
      </li>
      <li>
        <a href="{{route('user.get-role')}}">
          <i class="bi bi-circle"></i><span>View Roles</span>
        </a>
      </li>
      <li>
        <a href="{{route('user.add-permission')}}">
          <i class="bi bi-circle"></i><span>Add Permissions</span>
        </a>
      </li>
      <li>
        <a href="{{route('user.get-permission')}}">
          <i class="bi bi-circle"></i><span>View Permissions</span>
        </a>
      </li>
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
    <i class="bi bi-person"></i><span>Products</span><i class="bi bi-chevron-down ms-auto"></i>
    </a>
    <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
      <li>
